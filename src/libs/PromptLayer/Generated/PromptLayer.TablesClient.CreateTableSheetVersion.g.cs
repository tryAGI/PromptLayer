...
namespace PromptLayer
{
    public partial class TablesClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_CreateTableSheetVersionSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_CreateTableSheetVersionSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_CreateTableSheetVersionSecurityRequirement0,
            };
        partial void PrepareCreateTableSheetVersionArguments(
        ...
        partial void PrepareCreateTableSheetVersionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid tableId,
            global::System.Guid sheetId,
            global::PromptLayer.CreateTableSheetVersionRequest request);
        partial void ProcessCreateTableSheetVersionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTableSheetVersionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.GetTableSheetVersionResponse> CreateTableSheetVersionAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
        ...
        {
            var __response = await CreateTableSheetVersionAsResponseAsync(
                tableId: tableId,
                sheetId: sheetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.GetTableSheetVersionResponse>> CreateTableSheetVersionAsResponseAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTableSheetVersionArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTableSheetVersionSecurityRequirements,
                operationName: "CreateTableSheetVersionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTableSheetVersionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateTableSheetVersionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTableSheetVersionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid request body or workspace context.
                            ...
                            // Table, sheet, or source version not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTableSheetVersionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.GetTableSheetVersionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.GetTableSheetVersionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.GetTableSheetVersionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.GetTableSheetVersionResponse> CreateTableSheetVersionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PromptLayer.CreateTableSheetVersionRequest
            {
                Name = name,
                SourceVersionId = sourceVersionId,
            };

            return await CreateTableSheetVersionAsync(
                tableId: tableId,
                sheetId: sheetId,
                request: __request,
                requestOptions: requestOptions,
