...
namespace PromptLayer
{
    public partial class EnvVarsClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_DeleteToolEnvVarSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_DeleteToolEnvVarSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_DeleteToolEnvVarSecurityRequirement0,
            };
        partial void PrepareDeleteToolEnvVarArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string identifier,
            ref int varId);
        partial void PrepareDeleteToolEnvVarRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string identifier,
            int varId);
        partial void ProcessDeleteToolEnvVarResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteToolEnvVarResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.DeleteToolEnvVarResponse> DeleteToolEnvVarAsync(
            string identifier,
            int varId,
            global::PromptLayer.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteToolEnvVarAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.DeleteToolEnvVarResponse>> DeleteToolEnvVarAsResponseAsync(
            string identifier,
            int varId,
            global::PromptLayer.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteToolEnvVarArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteToolEnvVarSecurityRequirements,
                operationName: "DeleteToolEnvVarAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteToolEnvVarRequest(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::PromptLayer.DeleteToolEnvVarResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::PromptLayer.DeleteToolEnvVarResponse2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PromptLayer.ApiException<global::PromptLayer.DeleteToolEnvVarResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteToolEnvVarResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.DeleteToolEnvVarResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.DeleteToolEnvVarResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.DeleteToolEnvVarResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
