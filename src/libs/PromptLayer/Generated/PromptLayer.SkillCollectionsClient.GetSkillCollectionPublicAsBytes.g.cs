...
namespace PromptLayer
{
    public partial class SkillCollectionsClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_GetSkillCollectionPublicAsBytesSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_GetSkillCollectionPublicAsBytesSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_GetSkillCollectionPublicAsBytesSecurityRequirement0,
            };
        partial void PrepareGetSkillCollectionPublicAsBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string identifier,
            ref global::PromptLayer.GetSkillCollectionPublicFormat? format,
            ref string? label,
            ref int? version);
        partial void PrepareGetSkillCollectionPublicAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? label,
            int? version);
        partial void ProcessGetSkillCollectionPublicAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSkillCollectionPublicAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> GetSkillCollectionPublicAsBytesAsync(
            string identifier,
        ...
        {
            var __response = await GetSkillCollectionPublicAsBytesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> GetSkillCollectionPublicAsBytesAsStreamAsync(
            string identifier,
            global::PromptLayer.GetSkillCollectionPublicFormat? format = default,
            string? label = default,
            int? version = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSkillCollectionPublicAsBytesArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSkillCollectionPublicAsBytesSecurityRequirements,
                operationName: "GetSkillCollectionPublicAsBytesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSkillCollectionPublicAsBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetSkillCollectionPublicAsBytes",
                                methodName: "GetSkillCollectionPublicAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSkillCollectionPublicAsBytesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::PromptLayer.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<byte[]>> GetSkillCollectionPublicAsBytesAsResponseAsync(
            string identifier,
            global::PromptLayer.GetSkillCollectionPublicFormat? format = default,
            string? label = default,
            int? version = default,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSkillCollectionPublicAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                ...
                                try
                                {
                                    ...
                                    return new global::PromptLayer.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
