...
namespace PromptLayer
{
    public partial class SmartTablesClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_UpdateTableSheetColumnSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_UpdateTableSheetColumnSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_UpdateTableSheetColumnSecurityRequirement0,
            };
        partial void PrepareUpdateTableSheetColumnArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid tableId,
            ref global::System.Guid sheetId,
            ref global::System.Guid columnId,
            global::PromptLayer.UpdateTableSheetColumnRequest request);
        partial void PrepareUpdateTableSheetColumnRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::PromptLayer.UpdateTableSheetColumnRequest request);
        partial void ProcessUpdateTableSheetColumnResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateTableSheetColumnResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.UpdateTableSheetColumnResponse> UpdateTableSheetColumnAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            global::System.Guid columnId,
        ...
        {
            var __response = await UpdateTableSheetColumnAsResponseAsync(
                tableId: tableId,
                sheetId: sheetId,
                columnId: columnId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.UpdateTableSheetColumnResponse>> UpdateTableSheetColumnAsResponseAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            global::System.Guid columnId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateTableSheetColumnArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateTableSheetColumnSecurityRequirements,
                operationName: "UpdateTableSheetColumnAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::PromptLayer.PathBuilder(
                                path: $"/api/public/v2/tables/{tableId}/sheets/{sheetId}/columns/{columnId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateTableSheetColumnRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateTableSheetColumn",
                                methodName: "UpdateTableSheetColumnAsync",
                                pathTemplate: "$\"/api/public/v2/tables/{tableId}/sheets/{sheetId}/columns/{columnId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateTableSheetColumnResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Cycle detected or invalid config
                            ...
                            // Table, sheet, or column not found
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateTableSheetColumnResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.UpdateTableSheetColumnResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.UpdateTableSheetColumnResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.UpdateTableSheetColumnResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.UpdateTableSheetColumnResponse> UpdateTableSheetColumnAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PromptLayer.UpdateTableSheetColumnRequest
            {
                Title = title,
                Config = config,
            ...
            return await UpdateTableSheetColumnAsync(
                tableId: tableId,
                sheetId: sheetId,
                columnId: columnId,
                request: __request,
