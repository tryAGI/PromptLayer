...
namespace PromptLayer
{
    public partial class EnvVarsClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_CreateWorkspaceEnvVarSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_CreateWorkspaceEnvVarSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_CreateWorkspaceEnvVarSecurityRequirement0,
            };
        partial void PrepareCreateWorkspaceEnvVarArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::PromptLayer.CreateWorkspaceEnvVarRequest request);
        partial void PrepareCreateWorkspaceEnvVarRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::PromptLayer.CreateWorkspaceEnvVarRequest request);
        partial void ProcessCreateWorkspaceEnvVarResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateWorkspaceEnvVarResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.CreateWorkspaceEnvVarResponse> CreateWorkspaceEnvVarAsync(

            global::PromptLayer.CreateWorkspaceEnvVarRequest request,
            global::PromptLayer.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateWorkspaceEnvVarAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CreateWorkspaceEnvVarResponse>> CreateWorkspaceEnvVarAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateWorkspaceEnvVarArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateWorkspaceEnvVarSecurityRequirements,
                operationName: "CreateWorkspaceEnvVarAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateWorkspaceEnvVar",
                                methodName: "CreateWorkspaceEnvVarAsync",
                                pathTemplate: "\"/api/public/v2/env-vars\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateWorkspaceEnvVarResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // An environment variable with that key already exists in this workspace.
                            if ((int)__response.StatusCode == 409)
                            {
                                string? __content_409 = null;
                                global::System.Exception? __exception_409 = null;
                                global::PromptLayer.CreateWorkspaceEnvVarResponse2? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::PromptLayer.CreateWorkspaceEnvVarResponse2.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PromptLayer.ApiException<global::PromptLayer.CreateWorkspaceEnvVarResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateWorkspaceEnvVarResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.CreateWorkspaceEnvVarResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CreateWorkspaceEnvVarResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.CreateWorkspaceEnvVarResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.CreateWorkspaceEnvVarResponse> CreateWorkspaceEnvVarAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PromptLayer.CreateWorkspaceEnvVarRequest
            {
                Key = key,
                Value = value,
            };

            return await CreateWorkspaceEnvVarAsync(
                request: __request,
                requestOptions: requestOptions,
