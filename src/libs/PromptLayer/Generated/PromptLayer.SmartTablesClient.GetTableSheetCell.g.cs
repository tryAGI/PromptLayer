...
namespace PromptLayer
{
    public partial class SmartTablesClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_GetTableSheetCellSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_GetTableSheetCellSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_GetTableSheetCellSecurityRequirement0,
            };
        partial void PrepareGetTableSheetCellArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid tableId,
            ref global::System.Guid sheetId,
            ref global::System.Guid cellId);
        partial void PrepareGetTableSheetCellRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid tableId,
            global::System.Guid sheetId,
            global::System.Guid cellId);
        partial void ProcessGetTableSheetCellResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTableSheetCellResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.GetTableSheetCellResponse> GetTableSheetCellAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            global::System.Guid cellId,
        ...
        {
            var __response = await GetTableSheetCellAsResponseAsync(
                tableId: tableId,
                sheetId: sheetId,
                cellId: cellId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.GetTableSheetCellResponse>> GetTableSheetCellAsResponseAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            global::System.Guid cellId,
            global::PromptLayer.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTableSheetCellArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTableSheetCellSecurityRequirements,
                operationName: "GetTableSheetCellAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTableSheetCellRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTableSheetCell",
                                methodName: "GetTableSheetCellAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTableSheetCellResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTableSheetCellResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.GetTableSheetCellResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.GetTableSheetCellResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.GetTableSheetCellResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
