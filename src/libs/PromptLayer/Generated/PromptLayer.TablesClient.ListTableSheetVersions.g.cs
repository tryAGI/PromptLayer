...
namespace PromptLayer
{
    public partial class TablesClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_ListTableSheetVersionsSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_ListTableSheetVersionsSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_ListTableSheetVersionsSecurityRequirement0,
            };
        partial void PrepareListTableSheetVersionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid tableId,
            ref global::System.Guid sheetId,
            ref string? cursor,
            ref int? limit,
            ref global::PromptLayer.ListTableSheetVersionsSort? sort,
            ref global::PromptLayer.ListTableSheetVersionsOrder? order);
        partial void PrepareListTableSheetVersionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? cursor,
            int? limit,
            global::PromptLayer.ListTableSheetVersionsSort? sort,
            global::PromptLayer.ListTableSheetVersionsOrder? order);
        partial void ProcessListTableSheetVersionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListTableSheetVersionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.ListTableSheetVersionsResponse> ListTableSheetVersionsAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
        ...
        {
            var __response = await ListTableSheetVersionsAsResponseAsync(
                tableId: tableId,
                sheetId: sheetId,
                cursor: cursor,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.ListTableSheetVersionsResponse>> ListTableSheetVersionsAsResponseAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            string? cursor = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListTableSheetVersionsArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListTableSheetVersionsSecurityRequirements,
                operationName: "ListTableSheetVersionsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::PromptLayer.PathBuilder(
                                path: $"/api/public/v2/tables/{tableId}/sheets/{sheetId}/versions",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListTableSheetVersionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListTableSheetVersionsAsync",
                                pathTemplate: "$\"/api/public/v2/tables/{tableId}/sheets/{sheetId}/versions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListTableSheetVersionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid cursor, query parameter, sort/order, filter set, or workspace context.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListTableSheetVersionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.ListTableSheetVersionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.ListTableSheetVersionsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.ListTableSheetVersionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
