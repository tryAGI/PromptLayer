...
namespace PromptLayer
{
    public partial class SmartTablesClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_UpdateTableSheetSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_UpdateTableSheetSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_UpdateTableSheetSecurityRequirement0,
            };
        partial void PrepareUpdateTableSheetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid tableId,
            ref global::System.Guid sheetId,
            global::PromptLayer.UpdateTableSheetRequest request);
        partial void PrepareUpdateTableSheetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid tableId,
            global::System.Guid sheetId,
            global::PromptLayer.UpdateTableSheetRequest request);
        partial void ProcessUpdateTableSheetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateTableSheetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.UpdateTableSheetResponse> UpdateTableSheetAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
        ...
        {
            var __response = await UpdateTableSheetAsResponseAsync(
                tableId: tableId,
                sheetId: sheetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.UpdateTableSheetResponse>> UpdateTableSheetAsResponseAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateTableSheetArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateTableSheetSecurityRequirements,
                operationName: "UpdateTableSheetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::PromptLayer.PathBuilder(
                                path: $"/api/public/v2/tables/{tableId}/sheets/{sheetId}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateTableSheet",
                                methodName: "UpdateTableSheetAsync",
                                pathTemplate: "$\"/api/public/v2/tables/{tableId}/sheets/{sheetId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateTableSheetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateTableSheetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.UpdateTableSheetResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.UpdateTableSheetResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.UpdateTableSheetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.UpdateTableSheetResponse> UpdateTableSheetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PromptLayer.UpdateTableSheetRequest
            {
                Title = title,
                Index = index,
            };

            return await UpdateTableSheetAsync(
                tableId: tableId,
                sheetId: sheetId,
                request: __request,
                requestOptions: requestOptions,
