...
namespace PromptLayer
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_CreatePromptLabelSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_CreatePromptLabelSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_CreatePromptLabelSecurityRequirement0,
            };
        partial void PrepareCreatePromptLabelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int promptId,
            global::PromptLayer.CreatePromptLabelRequest request);
        partial void PrepareCreatePromptLabelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int promptId,
            global::PromptLayer.CreatePromptLabelRequest request);
        partial void ProcessCreatePromptLabelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePromptLabelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.CreatePromptLabelResponse> CreatePromptLabelAsync(
            int promptId,
        ...
        {
            var __response = await CreatePromptLabelAsResponseAsync(
                promptId: promptId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CreatePromptLabelResponse>> CreatePromptLabelAsResponseAsync(
            int promptId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePromptLabelArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePromptLabelSecurityRequirements,
                operationName: "CreatePromptLabelAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreatePromptLabel",
                                methodName: "CreatePromptLabelAsync",
                                pathTemplate: "$\"/prompts/{promptId}/label\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePromptLabelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePromptLabelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.CreatePromptLabelResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CreatePromptLabelResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.CreatePromptLabelResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.CreatePromptLabelResponse> CreatePromptLabelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PromptLayer.CreatePromptLabelRequest
            {
                PromptVersionNumber = promptVersionNumber,
                Name = name,
            };

            return await CreatePromptLabelAsync(
                promptId: promptId,
                request: __request,
                requestOptions: requestOptions,
