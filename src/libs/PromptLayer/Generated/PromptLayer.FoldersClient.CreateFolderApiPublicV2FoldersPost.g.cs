            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_400 = global::PromptLayer.AnyOf<global::PromptLayer.FolderExistsError, string>.FromJson(__content_400, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_404 = global::PromptLayer.ParentFolderNotFoundError.FromJson(__content_404, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
