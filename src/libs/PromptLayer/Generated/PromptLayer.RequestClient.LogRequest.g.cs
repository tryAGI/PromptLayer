            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_400 = global::PromptLayer.AnyOf<global::PromptLayer.BadRequestError, global::PromptLayer.ValidationError>.FromJson(__content_400, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_404 = global::PromptLayer.BadRequestError.FromJson(__content_404, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::PromptLayer.LogRequestResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::PromptLayer.LogRequestResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
