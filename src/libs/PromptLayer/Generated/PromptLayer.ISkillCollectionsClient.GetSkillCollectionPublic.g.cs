...
namespace PromptLayer
{
    public partial interface ISkillCollectionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.GetSkillCollectionResponse>> GetSkillCollectionPublicAsResponseAsync(
            string identifier,
            global::PromptLayer.GetSkillCollectionPublicFormat? format = default,
            string? label = default,
            int? version = default,
