...
namespace PromptLayer
{
    public partial class FoldersClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CreateFolderSuccessResponse>> UpdateFolderApiPublicV2FoldersPatchAsResponseAsync(
            int folderId,
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_400 = global::PromptLayer.FolderExistsError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PromptLayer.ApiException<global::PromptLayer.FolderExistsError>.Create(
