...
namespace PromptLayer
{
    public partial class TablesClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_CancelTableSheetOperationSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_CancelTableSheetOperationSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_CancelTableSheetOperationSecurityRequirement0,
            };
        partial void PrepareCancelTableSheetOperationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid tableId,
            ref global::System.Guid sheetId,
            ref string operationId);
        partial void PrepareCancelTableSheetOperationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid tableId,
            global::System.Guid sheetId,
            string operationId);
        partial void ProcessCancelTableSheetOperationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelTableSheetOperationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.CancelTableSheetOperationResponse> CancelTableSheetOperationAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            string operationId,
        ...
        {
            var __response = await CancelTableSheetOperationAsResponseAsync(
                tableId: tableId,
                sheetId: sheetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CancelTableSheetOperationResponse>> CancelTableSheetOperationAsResponseAsync(
            global::System.Guid tableId,
            global::System.Guid sheetId,
            string operationId,
            global::PromptLayer.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelTableSheetOperationArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelTableSheetOperationSecurityRequirements,
                operationName: "CancelTableSheetOperationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::PromptLayer.PathBuilder(
                                path: $"/api/public/v2/tables/{tableId}/sheets/{sheetId}/operations/{operationId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCancelTableSheetOperationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CancelTableSheetOperationAsync",
                                pathTemplate: "$\"/api/public/v2/tables/{tableId}/sheets/{sheetId}/operations/{operationId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelTableSheetOperationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelTableSheetOperationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.CancelTableSheetOperationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CancelTableSheetOperationResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.CancelTableSheetOperationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
