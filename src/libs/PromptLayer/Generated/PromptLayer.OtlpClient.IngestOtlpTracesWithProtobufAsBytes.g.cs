...
namespace PromptLayer
{
    public partial class OtlpClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_IngestOtlpTracesWithProtobufAsBytesSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_IngestOtlpTracesWithProtobufAsBytesSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_IngestOtlpTracesWithProtobufAsBytesSecurityRequirement0,
            };
        partial void PrepareIngestOtlpTracesWithProtobufAsBytesArguments(
            ...
            ref bool? closeAfter,
            byte[] request);
        partial void PrepareIngestOtlpTracesWithProtobufAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? closeAfter,
            byte[] request);
        partial void ProcessIngestOtlpTracesWithProtobufAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIngestOtlpTracesWithProtobufAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> IngestOtlpTracesWithProtobufAsBytesAsync(
            global::PromptLayer.IngestOtlpTracesContentType contentType,
        ...
        {
            var __response = await IngestOtlpTracesWithProtobufAsBytesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> IngestOtlpTracesWithProtobufAsBytesAsStreamAsync(
            global::PromptLayer.IngestOtlpTracesContentType contentType,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareIngestOtlpTracesWithProtobufAsBytesArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_IngestOtlpTracesWithProtobufAsBytesSecurityRequirements,
                operationName: "IngestOtlpTracesWithProtobufAsBytesAsync");
            ...
            if (contentEncoding != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareIngestOtlpTracesWithProtobufAsBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "IngestOtlpTracesWithProtobufAsBytes",
                                methodName: "IngestOtlpTracesWithProtobufAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessIngestOtlpTracesWithProtobufAsBytesResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<byte[]>> IngestOtlpTracesWithProtobufAsBytesAsResponseAsync(
            global::PromptLayer.IngestOtlpTracesContentType contentType,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessIngestOtlpTracesWithProtobufAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
