...
namespace PromptLayer
{
    public partial class EnvVarsClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_UpdateToolEnvVarSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_UpdateToolEnvVarSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_UpdateToolEnvVarSecurityRequirement0,
            };
        partial void PrepareUpdateToolEnvVarArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string identifier,
            ref int varId,
            global::PromptLayer.UpdateToolEnvVarRequest request);
        partial void PrepareUpdateToolEnvVarRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string identifier,
            int varId,
            global::PromptLayer.UpdateToolEnvVarRequest request);
        partial void ProcessUpdateToolEnvVarResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateToolEnvVarResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.UpdateToolEnvVarResponse> UpdateToolEnvVarAsync(
            string identifier,
            int varId,
        ...
        {
            var __response = await UpdateToolEnvVarAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.UpdateToolEnvVarResponse>> UpdateToolEnvVarAsResponseAsync(
            string identifier,
            int varId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateToolEnvVarArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateToolEnvVarSecurityRequirements,
                operationName: "UpdateToolEnvVarAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::PromptLayer.PathBuilder(
                                path: $"/api/public/v2/tool-registry/{identifier}/env-vars/{varId}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateToolEnvVar",
                                methodName: "UpdateToolEnvVarAsync",
                                pathTemplate: "$\"/api/public/v2/tool-registry/{identifier}/env-vars/{varId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateToolEnvVarResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Tool or env var not found.
                            if ((int)__response.StatusCode == 404)
                            {
                                string? __content_404 = null;
                                global::System.Exception? __exception_404 = null;
                                global::PromptLayer.UpdateToolEnvVarResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::PromptLayer.UpdateToolEnvVarResponse2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PromptLayer.ApiException<global::PromptLayer.UpdateToolEnvVarResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateToolEnvVarResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.UpdateToolEnvVarResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.UpdateToolEnvVarResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.UpdateToolEnvVarResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.UpdateToolEnvVarResponse> UpdateToolEnvVarAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PromptLayer.UpdateToolEnvVarRequest
            {
                Value = value,
            };

            return await UpdateToolEnvVarAsync(
                identifier: identifier,
                varId: varId,
                request: __request,
                requestOptions: requestOptions,
