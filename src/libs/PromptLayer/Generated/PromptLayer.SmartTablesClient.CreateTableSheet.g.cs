...
namespace PromptLayer
{
    public partial class SmartTablesClient
    {
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement s_CreateTableSheetSecurityRequirement0 =
        ...
        private static readonly global::PromptLayer.EndPointSecurityRequirement[] s_CreateTableSheetSecurityRequirements =
            new global::PromptLayer.EndPointSecurityRequirement[]
            {                s_CreateTableSheetSecurityRequirement0,
            };
        partial void PrepareCreateTableSheetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid tableId,
            global::PromptLayer.CreateTableSheetRequest request);
        partial void PrepareCreateTableSheetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid tableId,
            global::PromptLayer.CreateTableSheetRequest request);
        partial void ProcessCreateTableSheetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTableSheetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.CreateTableSheetResponse> CreateTableSheetAsync(
            global::System.Guid tableId,
        ...
        {
            var __response = await CreateTableSheetAsResponseAsync(
                tableId: tableId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CreateTableSheetResponse>> CreateTableSheetAsResponseAsync(
            global::System.Guid tableId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTableSheetArguments(
            ...
            var __authorizations = global::PromptLayer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTableSheetSecurityRequirements,
                operationName: "CreateTableSheetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::PromptLayer.PathBuilder(
                                path: $"/api/public/v2/tables/{tableId}/sheets",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTableSheetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::PromptLayer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTableSheet",
                                methodName: "CreateTableSheetAsync",
                                pathTemplate: "$\"/api/public/v2/tables/{tableId}/sheets\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTableSheetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTableSheetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.CreateTableSheetResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.CreateTableSheetResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.CreateTableSheetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.CreateTableSheetResponse> CreateTableSheetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::PromptLayer.CreateTableSheetRequest
            {
                Title = title,
                Index = index,
            ...
            return await CreateTableSheetAsync(
                tableId: tableId,
                request: __request,
                requestOptions: requestOptions,
