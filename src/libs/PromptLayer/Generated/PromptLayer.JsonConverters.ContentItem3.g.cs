...
{
    /// <inheritdoc />
    public class ContentItem3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::PromptLayer.ContentItem3>
    {
        /// <inheritdoc />
        public override global::PromptLayer.ContentItem3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::PromptLayer.UserMessageContentItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::PromptLayer.UserMessageContentItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::PromptLayer.UserMessageContentItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::PromptLayer.TextContent? text = default;
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.Thinking)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.Code)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.ImageUrl)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.Media)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.MediaVariable)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.OutputMedia)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.ServerToolUse)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.WebSearchToolResult)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.CodeExecutionResult)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.McpListTools)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.McpCall)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.McpApprovalRequest)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.McpApprovalResponse)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.BashCodeExecutionToolResult)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.TextEditorCodeExecutionToolResult)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.ShellCall)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.ShellCallOutput)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.ApplyPatchCall)
            {
            ...
            if (discriminator?.Type == global::PromptLayer.UserMessageContentItemDiscriminatorType.ApplyPatchCallOutput)
            {
            ...
            var __value = new global::PromptLayer.ContentItem3(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::PromptLayer.ContentItem3 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
