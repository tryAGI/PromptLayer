...
namespace PromptLayer
{
    ...
    {
        /// <summary>
        /// JSON string metadata containing `moves`, `deletes`, `commit_message`, `release_label`, and `file_updates`.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveSkillCollectionVersionMultipartRequest" /> class.
        /// </summary>
        /// <param name="metadata">
        /// JSON string metadata containing `moves`, `deletes`, `commit_message`, `release_label`, and `file_updates`.
        /// </param>
...
#endif
        public SaveSkillCollectionVersionMultipartRequest(
            string? metadata,
            string? json,
            byte[]? archive,
            string? archivename,
