...
namespace PromptLayer
{
    public partial class WorkflowClient
    {
        ...
        partial void PrepareListWorkflowsArguments(
            ...
            ref global::PromptLayer.ListWorkflowsSortBy? sortBy,
            ref global::PromptLayer.ListWorkflowsSortOrder? sortOrder);
        partial void PrepareListWorkflowsRequest(
            ...
            string? externalId,
            global::PromptLayer.ListWorkflowsSortBy? sortBy,
            global::PromptLayer.ListWorkflowsSortOrder? sortOrder);
        ...
        public async global::System.Threading.Tasks.Task<global::PromptLayer.ListWorkflowsResponse> ListWorkflowsAsync(
            int? page = default,
            int? perPage = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::PromptLayer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.ListWorkflowsResponse>> ListWorkflowsAsResponseAsync(
            int? page = default,
            int? perPage = default,
            string? createdByEmail = default,
            global::System.DateTime? createdAfter = default,
                ...
                else
                {
                    await global::PromptLayer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::PromptLayer.ListWorkflowsResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::PromptLayer.ListWorkflowsResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PromptLayer.ApiException<global::PromptLayer.ListWorkflowsResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::PromptLayer.ListWorkflowsResponse3? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::PromptLayer.ListWorkflowsResponse3.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::PromptLayer.ApiException<global::PromptLayer.ListWorkflowsResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::PromptLayer.ListWorkflowsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::PromptLayer.AutoSDKHttpResponse<global::PromptLayer.ListWorkflowsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::PromptLayer.ListWorkflowsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
